...
const inputHandleBlur = async ({ ...args }) => {
    ...
    const result2 = await Object.keys(target).length === 0 && target.constructor === Object && !saveVacationOrDesiderataId ? api_root_days.deleteDay({taserId, userId, dayNumber}).then(()=>mutation()) : ""
}
